                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-right">
                            <span
                              className={`px-2 py-0.5 rounded text-[9px] font-space font-bold border uppercase ${isMeWinner
                      ...
                      return (
                        <div key={friend.id} className="flex items-center justify-between text-xs">
                          ...
                          <button
                            ...
                            disabled={!isOnline}
                            className={`font-space font-bold uppercase tracking-wider text-[10px] px-3 py-1.5 rounded-lg border transition ${isOnline
