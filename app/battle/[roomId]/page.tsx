                        ...
                        <div className="space-y-2">
                          {testResults.map((tr) => (
                            <div
                              ...
                              className={`border rounded-xl p-4 flex flex-col space-y-2 ${tr.passed
                        ...
                        <div className="h-14 bg-surface border-b border-khaki/10 flex items-center justify-between px-6 flex-shrink-0 relative z-10 font-sans">
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <button
                              ...
                              className={`px-3 py-1.5 rounded border text-[9px] font-space font-bold uppercase transition ${snapToGrid
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                ...
                                <button
                                  ...
                                  className={`p-2 rounded-lg border text-xs font-space font-bold uppercase transition flex flex-col items-center justify-center space-y-1 ${selectedTool === "select"
                                      ? "bg-sand text-bg border-sand"
                                ...
                                <button
                                  ...
                                  className={`p-2 rounded-lg border text-xs font-space font-bold uppercase transition flex flex-col items-center justify-center space-y-1 ${selectedTool === "arrow"
                                      ? "bg-sand text-bg border-sand"
                                      : "bg-surface2 border-khaki/10 text-cream hover:border-sand"
                                    }`}
                                >
                                ...
                                <button
                                  ...
                                  className={`p-2 rounded-lg border text-xs font-space font-bold uppercase transition flex flex-col items-center justify-center space-y-1 ${selectedTool === "textLabel"
                                      ? "bg-sand text-bg border-sand"
                                      : "bg-surface2 border-khaki/10 text-cream hover:border-sand"
                                    }`}
                                >
                                ...
                                <button
                                  ...
                                  className={`p-2 rounded-lg border text-xs font-space font-bold uppercase transition flex flex-col items-center justify-center space-y-1 ${selectedTool === "stickyNote"
                                      ? "bg-sand text-bg border-sand"
                                      : "bg-surface2 border-khaki/10 text-cream hover:border-sand"
                                    }`}
                                >
                              ...
                              <div className="space-y-1.5 flex-1 overflow-y-auto pr-1">
                                {Object.entries(NODE_CONFIGS).map(([type, config]) => (
                                  <button
                                    ...
                                    className={`w-full px-3 py-2 rounded-lg border text-left text-[9px] font-space font-bold uppercase transition flex items-center justify-between ${selectedTool === type
                                        ? "bg-sand text-bg border-sand"
                                        : "bg-surface2 border-khaki/10 text-cream hover:border-sand"
                                      }`}
                                  >
                                  ...
                                  <div className="flex bg-bg/50 border border-khaki/10 rounded-lg p-0.5 space-x-1">
                                    {["solid", "dashed", "dotted"].map((style) => (
                                      <button
                                        ...
                                        className={`px-2.5 py-1 rounded text-[9px] font-space font-bold uppercase transition ${(style === "solid" && !selectedEdge.animated && !selectedEdge.style?.strokeDasharray) ||
